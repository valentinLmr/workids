...
dashboardLink: document.querySelector('.dashboard_link'),
divIdsService: document.querySelector('.divIdsService'),
divFormUserService: document.querySelector('.divFormUserService'),
divFormUserServiceIcon: document.querySelector('.divFormUserServiceIcon'),
...
searchServiceInput: document.querySelector('.searchServiceInput'),
searchIdsService: document.querySelector('.searchIdsService'),
